...
const cacheName = 'ExtraXPFixit7AlexandraJoas-2020-09-28 17:32:00.999988'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'ExtraXPFixit7AlexandraJoas'.length) === 'ExtraXPFixit7AlexandraJoas') {
